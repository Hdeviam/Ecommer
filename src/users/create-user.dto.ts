import { IsString, IsEmail, IsNotEmpty, MinLength, MaxLength, Matches, IsEmpty, IsOptional } from 'class-validator';
...
export class CreateUserDto {
  ...
  @Matches(/^[A-Za-zÀ-ÿ\s]+$/, { message: 'solo puede contener letras y espacios.' })
  name: string;
